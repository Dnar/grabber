...
var EditableCell = /** @class */ (function (_super) {
    ...
    EditableCell.prototype.render = function () {
        ...
        if (isEditing) {
            cellContents = (React.createElement(core_1.EditableText, { isEditing: true, className: classnames_1.default(Classes.TABLE_EDITABLE_TEXT, Classes.TABLE_EDITABLE_NAME), intent: spreadableProps.intent, minWidth: null, onCancel: this.handleCancel, onChange: this.handleChange, onConfirm: this.handleConfirm, onEdit: this.handleEdit, placeholder: "", selectAllOnFocus: false, value: dirtyValue }));
        }
        else {
            var textClasses = classnames_1.default(Classes.TABLE_EDITABLE_TEXT, (_c = {},
